...
2. Create a MongoDB database called `OMDb`.

3. Using mongoose, then create an Article schema and model

4. At a minimum, articles should have each of the following fields:

   * `title` (Title of the stored article from OMDbimes.com)

   * `date` (publish date and time of the article)

   * `url` (URL of the article on OMDbimes.com)
...
5. Create a Node/Express/MongoDB/ReactJS app called `OMDb`. This will be a recreation of the [OMDb Articles Search](https://nytarticle-search-fsf.herokuapp.com/) exercise application we built back in [Week 3](../../../06-ajax/Activities/16-OMDbSearch/Solved/index.html). Running this application will:
...
* Deploy your application to Heroku once complete. Feel free to use the [Mern Example](../../Activities/07-Ins_Boilerplate) as a starting point. **You must use Create React App** and current versions of React and React-Router-Dom for this assignment.
